...
public class Monster : MonoBehaviour
{
    ...
    public virtual void Update()
    {
        ...
        if (limb1 && (health <= 0 || Physics.Raycast(limb1.rayStart.position, limb1.transform.position - limb1.rayStart.position, out limb1Hit) && limb1Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb2 && (health <= 0 || Physics.Raycast(limb2.rayStart.position, limb2.transform.position - limb2.rayStart.position, out limb2Hit) && limb2Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb3 && (health <= 0 || Physics.Raycast(limb3.rayStart.position, limb3.transform.position - limb3.rayStart.position, out limb3Hit) && limb3Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb4 && (health <= 0 || Physics.Raycast(limb4.rayStart.position, limb4.transform.position - limb4.rayStart.position, out limb4Hit) && limb4Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb5 && (health <= 0 || Physics.Raycast(limb5.rayStart.position, limb5.transform.position - limb5.rayStart.position, out limb5Hit) && limb5Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb6 && (health <= 0 || Physics.Raycast(limb6.rayStart.position, limb6.transform.position - limb6.rayStart.position, out limb6Hit) && limb6Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb7 && (health <= 0 || Physics.Raycast(limb7.rayStart.position, limb7.transform.position - limb7.rayStart.position, out limb7Hit) && limb7Hit.transform.gameObject.CompareTag("Weapon")))
        {
        ...
        if (limb8 && (health <= 0 || Physics.Raycast(limb8.rayStart.position, limb8.transform.position - limb8.rayStart.position, out limb8Hit) && limb8Hit.transform.gameObject.CompareTag("Weapon")))
        {
